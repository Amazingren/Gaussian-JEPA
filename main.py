...
def main():
    ...
    # Import the training stack only after CLI parsing. This keeps lightweight
    # commands such as ``python main.py --help`` independent of compiled CUDA
    # extensions while preserving the original execution path.
    import os
    import time
    ...
    if args.use_wandb:
        wandb.init(project="Gaussian-JEPA", config=config, name=args.exp_name)
    # run
    if args.test:
